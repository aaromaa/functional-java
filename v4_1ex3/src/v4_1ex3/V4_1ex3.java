...
public class V4_1ex3 {
    ...
    public static void main(String[] args) {
      ...
      /* System.out.println("Iterative Sum done in: " + measurePerf(ParallelStreams::iterativeSum, 10_000_000) + " msecs");
        ...
        System.out.println("SideEffect parallel with Long sum done in: " + measurePerf(ParallelStreams::sideEffectParallelSumLong, 10_000_000L) + " msecs" );
    */
        System.out.println("own test: " + measurePerf(ParallelStreams::hidasNelioSumma,1000000) + " msecs");
    }
